      ...
      <div className="bip-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="bip-head">
          ...
          <div>
            ...
            <div className="bip-cl">GSTIN: 08AAFCM15Q1ZA · ☎ 80941 56965 · temple@mtcpl.co</div>
          </div>
          <div>
        ...
        {items.length === 0 ? (
          ...
          <>
            ...
            <div className="bip-words"><strong>Amount in words:</strong> {amountInWordsIN(disc.payable)}</div>
          </>
        )}
